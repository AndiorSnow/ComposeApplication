...
import com.example.composeapplication.banya.ui.theme.ColorPalette

/**
 * A [MaterialTheme] for Banya.
 */
@Composable
fun BanyaTheme(content: @Composable () -> Unit) {
 ...
 */
@Composable
fun BanyaDialogThemeOverlay(content: @Composable () -> Unit) {
